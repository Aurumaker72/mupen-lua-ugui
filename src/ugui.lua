...
ugui.start = function(params, start)
    ...
    emu.atdrawd2d(function()
        ...
        local node_at_mouse = ugui.util.node_at_point(mouse_point, root_node)
        local node_at_last_mouse = ugui.util.node_at_point(last_mouse_point, root_node)
        local node_at_lmb_down = ugui.util.node_at_point(last_lmb_down_pos, root_node)
